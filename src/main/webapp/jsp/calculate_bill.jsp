...
<div class="bill-container">
    ...
    <!--  Bill Summary Section (Styled like a receipt) -->
    <div id="billSummary" class="bill-summary" style="display: none;">
        ...
        <div class="receipt">
            ...
            <p><strong>Base Fare:</strong>  <span id="summaryBaseFare"></span></p>
            <p><strong>Distance:</strong> <span id="summaryDistance"></span> KM</p>
            <p><strong>Tax Amount:</strong>  <span id="summaryTax"></span></p>
            <p><strong>Discount Applied:</strong>  <span id="summaryDiscount"></span></p>
            <hr>
            <p class="total-amount"><strong>Total Fare:</strong>  <span id="summaryTotal"></span></p>
        </div>
    </div>
</div>
